...
export default function Admin() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            let res = await axios.post('https://evening-meadow-95836.herokuapp.com/admin/registerUser', { userName, phone, password })
            ...
            if (err.response.data.message.phone === 'short') {
                ...
                setError('عذرا هذا الهاتف مسجل لدينا حاولي تسجيل الدخول او التواصل مع اداره الموقع')
            } else {
        ...
        <div className="wrapper fadeInDown">
            <div id="formContent">
                ...
                <form onSubmit={e => handleSubmit(e)}>
                    <input required value={userName} onChange={e => setName(e.target.value)} type="string" id="login" className="fadeIn second" name="login" placeholder="الإسم" />
                ...
                <div id="formFooter">
                    <Link to='/login' className="underlineHover">اذا كنتي مسجلة لدينا يمكنك الدخول من هنا</Link>
                </div>
